...
## 2026-06-13 — Lane A: DTE 9.1 polish — validación estructural antes de quemar folio (PR #145)
...
- **Tests**: +9 en `emit.rs` (nota sin ref / cod_ref inválido / ref válida ok; guía sin traslado / fuera de rango / válida ok; receptor incompleto; factura 100% exenta rechazada). GATE workspace verde (dte consumido por api, cross-crate): `fmt` + `clippy -D warnings` + **488 passed / 6 ignored** (+8). Commit en PR #145.
