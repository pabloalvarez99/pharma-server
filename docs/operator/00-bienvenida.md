---
title: 00 · Bienvenida y vista general
...
Si necesitás cambiar la dirección del servidor (algo que normalmente no toca al
operador), hay un enlace gris que dice **Conexión avanzada**. Lo dejás como
está si tu técnico no te dijo lo contrario.

### Pantalla 2 — el panel principal (AppShell)

Cuando entrás correctamente, la pantalla de login se desvanece y aparece el
**panel principal** del sistema. Tiene tres zonas:

> (ver captura: vista general del panel principal con menú lateral)
...
**Tomá tu tiempo.** No hay nada que se pueda romper si tocás un botón equivocado.
Cada acción se confirma antes de guardarse, y si te equivocaste podés siempre
volver al menú de la izquierda.

> Siguiente paso: [Tu primer inicio de sesión](./01-primer-inicio.md).
